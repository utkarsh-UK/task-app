  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SafeArea(child: Obx(() {
        int createdTasks = homeController.getTotalTask();
        int completedTasks = homeController.getTotalDoneTask();
        int liveTasks = createdTasks - completedTasks;
        String percent = (completedTasks / createdTasks * 100).toStringAsFixed(2);
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Efficiency',
                        style: TextStyle(
                            fontWeight: FontWeight.bold, fontSize: 12.0.sp, color: Colors.grey),
                      ),
                    ],
                  ),
                ),
